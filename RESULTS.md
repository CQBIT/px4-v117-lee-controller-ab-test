...
This report is generated from the real PX4 v1.17 SITL + Gazebo `x500` + ROS 2 experiment outputs. It is not based on a standalone or estimated simulation. The full GitHub Actions artifact contains the non-empty PX4 ULog for each case; the lightweight repository copy intentionally omits those large files.

- GitHub Actions run: https://github.com/CQBIT/px4-v117-lee-controller-ab-test/actions/runs/33458170651
- Tested source commit: `3a985276b9884513d19a96f46e58333703fb6256`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| aggressive | rate | 2705 | 25.02 | yes | 0 |  | 0 |
| aggressive | torque | 2705 | 25.02 | yes | 0 |  | 0 |
| circle | rate | 2705 | 25.02 | yes | 0 |  | 0 |
| circle | torque | 2704 | 25.02 | yes | 0 |  | 0 |
| figure8 | rate | 2705 | 25.02 | yes | 0 |  | 0 |
| figure8 | torque | 2704 | 25.01 | yes | 0 |  | 0 |
| hover | rate | 2705 | 25.02 | yes | 0 |  | 0 |
| hover | torque | 2705 | 25.02 | yes | 0 |  | 0 |
